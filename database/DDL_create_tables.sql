...
drop table if exists netbizz.warehouse cascade;
drop table if exists netbizz.attachment cascade ;
drop table if exists netbizz.notification cascade ;
drop table if exists netbizz.task_instance cascade ;
drop table if exists netbizz.workflow_instance cascade ;
drop table if exists netbizz.transition cascade ;
drop table if exists netbizz.task_definition cascade ;
drop table if exists netbizz.workflow_definition cascade ;
drop table if exists netbizz.bid_request cascade ;
drop table if exists netbizz.user_job_position cascade ;
drop table if exists netbizz.job_position cascade ;
drop table if exists netbizz.user_role cascade ;
drop table if exists netbizz.application_user cascade ;
drop table if exists netbizz.tenant_department cascade ;
drop table if exists netbizz.tenant_company cascade ;
