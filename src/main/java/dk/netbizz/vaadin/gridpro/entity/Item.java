...
import dk.netbizz.vaadin.gridpro.entity.base.ArrayDoubleEditor;
...
public class Item implements BaseEntity {
    ...
    @GridEditColumn(header = "Item Name", order = 1, editorClass = TextField.class)
    private String itemName = "New name ...";

    @GridEditColumn(header = "Category", order = 2, sortable = false, editorClass = Select.class)
    private String category = "";

    @GridEditColumn(header = "Price", order = 3, format = "%d kr.", editorClass = IntegerField.class)
    private Integer price = 0;

    @GridEditColumn(header = "Birthday", order = 4, format = "dd.MM.yyyy", editorClass = DatePicker.class)
    private LocalDate birthday;

    @GridEditColumn(header = "Age", order = 5)
    public int getAge() {
    ...
    @GridEditColumn(header = "Year", order = 7, sortable = false, format = "%d kg.", arrayEndIdx = 9, editorClass = ArrayIntegerEditor.class)
    ...
    @GridEditColumn(header = "Silo", order = 8, sortable = false, format = "%.2f Ton", arrayEndIdx = 9, editorClass = ArrayDoubleEditor.class)
