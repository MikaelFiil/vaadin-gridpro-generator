...
public class Resource implements BaseEntity {
    ...
    @GridEditColumn(header = "Margin", order = 4, fieldLength = 7, maxValue = 9999, format = GenericGridProEditView.CURRENCY_FORMAT, textAlign =  ColumnTextAlign.END, editorClass = IntegerField.class)
