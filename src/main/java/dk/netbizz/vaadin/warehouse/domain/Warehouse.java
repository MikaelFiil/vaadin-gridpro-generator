...
public class Warehouse implements BaseEntity {
    ...
    @GridEditColumn(header = "M2", order = 4, fieldLength = 5, minValue = 0, maxValue = 9999, format = GenericGridProEditView.THOUSAND_FORMAT + " m2", textAlign =  ColumnTextAlign.END, editorClass = IntegerField.class)
    Integer sqrM2;
