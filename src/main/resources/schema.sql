...
create index on bid_request(created_by_user);
...
create unique index on workflow_definition(name);
...
create unique index on task_definition(workflow_definition_id, name);
create index on task_definition(workflow_definition_id);
...
create index on transition(workflow_definition_id);
create index on transition(source_task_definition_id);
create index on transition(target_task_definition_id);
...
create index on workflow_instance(workflow_definition_id);
create index on workflow_instance(bid_request_id);
...
create index on task_instance(workflow_instance_id);
create index on task_instance(task_definition_id);
create index on task_instance(assigned_user_id);
...
create index on notification(workflow_instance_id);
create index on notification(task_instance_id);
...
create index on attachment(workflow_instance_id);
create index on attachment(task_instance_id);
create index on attachment(attached_by_user_id);
